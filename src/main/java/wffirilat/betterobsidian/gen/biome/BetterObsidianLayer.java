...
public class BetterObsidianLayer extends GenLayer {
	...
	public BetterObsidianLayer(long p_i2122_1_, GenLayer genLayer, WorldType worldType) {
		super(p_i2122_1_);
		...
		if (worldType == WorldType.DEFAULT_1_1) {
			...
			desertBiomes.add(new BiomeEntry(ModBiomes.volcanoBiome, 10));
		} else {
