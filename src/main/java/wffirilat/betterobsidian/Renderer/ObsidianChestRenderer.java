...
public class ObsidianChestRenderer extends TileEntitySpecialRenderer {
	// private static final ResourceLocation field_147507_b = new
	// ResourceLocation("textures/entity/chest/trapped_double.png");
	// private static final ResourceLocation field_147508_c = new
	// ResourceLocation("textures/entity/chest/christmas_double.png");
	private static final ResourceLocation field_147505_d = new ResourceLocation(Constants.MODID + ":" + "textures/blocks/largeObsidianChest.png");
	// private static final ResourceLocation field_147506_e = new
	// ResourceLocation("textures/entity/chest/trapped.png");
	// private static final ResourceLocation field_147503_f = new
	// ResourceLocation("textures/entity/chest/christmas.png");
	private static final ResourceLocation field_147504_g = new ResourceLocation(Constants.MODID + ":" + "textures/blocks/obsidianChest.png");
	private ModelChest field_147510_h = new ModelChest();
	private ModelChest field_147511_i = new ModelLargeChest();
	private boolean field_147509_j;
	private static final String __OBFID = "CL_00000965";

	public ObsidianChestRenderer() {
	...
	public void renderTileEntityAt(TileEntityObsidianChest p_147500_1_, double p_147500_2_, double p_147500_4_, double p_147500_6_, float p_147500_8_) {
		int i;
	...
	public void renderTileEntityAt(TileEntity p_147500_1_, double p_147500_2_, double p_147500_4_, double p_147500_6_, float p_147500_8_) {
		this.renderTileEntityAt((TileEntityObsidianChest) p_147500_1_, p_147500_2_, p_147500_4_, p_147500_6_, p_147500_8_);
	}
}